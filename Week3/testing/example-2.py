...
def miles_per_gallon(start_miles, end_miles, amount_gallons) -> float: # type: ignore
    ...
    """
    distance = end_miles - start_miles # type: ignore
    mpg = distance / amount_gallons # type: ignore
    return mpg # type: ignore
