# Benjamin Strong W04 Chemisty MIDWEEK CSE111
...
def main():
    ...
    periodic_table_dict = make_periodic_table() # type: ignore
    print("Periodic Table Dictionary:")
    for key in periodic_table_dict:
        print(f"{key}: {periodic_table_dict[key]}")
